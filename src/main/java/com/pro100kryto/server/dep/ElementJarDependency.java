...
import static com.pro100kryto.server.utils.UtilsInternal.iterateAttributeValues;
...
public abstract class ElementJarDependency extends JarDependency {
    ...
    protected void addDependencies(ArrayList<IDependency> dependencyListOut) throws Throwable {
        ...
        try (final JarFile jarFile = new JarFile( file )) {
            ...
            iterateAttributeValues(attributes, "Service-Shared-Subtype", (val) -> {
            ...
            iterateAttributeValues(attributes, "Service-Shared-Jar", (val) -> {
            ...
            iterateAttributeValues(attributes, "Module-Shared-Subtype", (val) -> {
            ...
            iterateAttributeValues(attributes, "Module-Shared-Jar", (val) -> {
                final Path path = Paths.get(
                        callback.getCorePath().toString(),
                        "modules",
                        val
            ...
            iterateAttributeValues(attributes, "Lib-Shared-Jar", (val) -> {
                final Path path = Paths.get(
                        callback.getCorePath().toString(),
                        "libs",
                        val
